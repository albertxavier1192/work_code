/* This is a modified version of svc_tcp.c from glibc-2.3.2.  It
 * performs operations over an authenticated, encrypted TLS
 * connection.  It uses GnuTLS.
 * By Richard Jones rjones~at~redhat~dot~com
 */
		  ...
		  gnutls_certificate_credentials_t x509_cred)
{
  ...
  if (r == NULL || xprt == NULL)
	...
	(void) fwprintf (stderr, L"%s", "svcgnutls_create: out of memory\n");
      else
#endif
	(void) fputs ("svcgnutls_create: out of memory\n", stderr);
      mem_free (r, sizeof (*r));
