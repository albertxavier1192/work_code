...
http://www.joinc.co.kr/modules/moniwiki/wiki.php/Code/C/ping
 */ 
...
static int in_cksum(register u_short *ptr, int nbytes)
{
...
{ 
	...
	{ 
		...
		s_ICMP->icmp_cksum = in_cksum((unsigned short *)(&s_ICMP_Packet[0]), sizeof(s_ICMP_Packet)); 
