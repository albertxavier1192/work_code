...
int main(int argc, char **argv)
{
	...
	int chans[] = {2412, 2417, 2422, 2427, 2432, 2437, 2442, 2447, 2452};/* 2457,
		2462, 2472, 5180, 5200, 5220, 5240, 5260, 5280, 5300, 5320, 5500, 5520,
		5540, 5560, 5580, 5600, 5620, 5640, 5660, 5680, 5700, 5745, 5765, 5785,
		5805, 5825};*/
	...
	char *ap = "\x22\x22\x22\x22\x22\x22";
	char *sta = "\x33\x33\x33\x33\x33\x33";
	...
	while(count--) {
		...
		// inject j times in the selected channel
		int j = 1;
		while(j--) {
#ifndef RAW
